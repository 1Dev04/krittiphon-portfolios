...
const ABCSHOP = {
  ...
  period: "มกราคม – เมษายน 2569",
  accentColor: "#34d399",
  accentGlow: "#059669",
  icon: "🐱",
  tag: "SENIOR PROJECT",
  stats: [
    { value: "70+", label: "วันพัฒนา",  sub: "ม.ค. – เม.ย. 2569" },
  ...
  tech: [
    ...
    { label: "YOLO v5",          cat: "AI/ML",    color: "#f97316" },
  ...
  months: [
    ...
    },
    {
      ...
      tasks: [
        ...
        "4–7 มี.ค. — แก้ History Cat Edit, Meow Size Recommendation Card V1–V3",
      ],
    },
    {
      month: "เมษายน", year: "2026", num: "05",
      color: "#fb923c", glow: "#ea580c", icon: "🏁",
      tasks: [
        "8 เม.ย. — Edit Meow Size (Recommend, Edit Cat, Backend Cat CRUD API)",
        "9 เม.ย. — เปลี่ยนมาใช้ OpenAI GPT-4.1 mini สำหรับ Detect & Analysis Cat",
        "10 เม.ย. — Edit Meow Size (Recommend, Edit Cat, History Analysis Cat)",
        "🎉 11 เม.ย. — SUCCESS PROJECT ABCat Shop",
      ],
    },
  ],
};
