...
/* ── Lang Toggle ── */
function LangToggle({ lang, setLang, isDark }: { lang:Lang; setLang:(l:Lang)=>void; isDark:boolean }) {
  ...
  const pillShadow  = isDark ? "0 0 14px rgba(167,139,250,0.25)" : "0 0 8px rgba(45,106,79,0.14)";
  ...
  return (
    <div style={{
      ...
      boxShadow: isDark ? "0 4px 20px rgba(124,58,237,0.18)" : "0 4px 16px rgba(20,60,35,0.10)",
    }}>
  ...
  return (
    ...
    >
      ...
      <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:14 }}>
        ...
        <span style={{ ...mono, fontSize:9, letterSpacing:"0.25em",
          color:tk.labelColor(color), fontWeight:700 }}>Q&amp;A</span>
        <span style={{
...
export default function ActivitiePage({ faqs = DEFAULT_FAQS }: ActivitiePageProps) {
  ...
  return (
    <section id="other-activites" style={{
      ...
      {/* orbs */}
      <div style={{ position:"absolute", width:560, height:560, top:"-15%", right:"-8%",
      ...
      <div style={{ position:"absolute", width:440, height:440, bottom:"0%", left:"-10%",
      ...
      <div style={{ position:"relative", zIndex:1 }}>
        ...
        <div style={{ textAlign:"center", marginBottom:64, padding:"0 24px",
          ...
          <div style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:14, marginBottom:14 }}>
            ...
            <span style={{ ...mono, fontSize:10, letterSpacing:".40em",
              color:tk.eyebrow, transition:"color .5s" }}>✦ 1DEV CODEX ✦</span>
          ...
          <p style={{ ...crimson, fontSize:15, color:tk.headingSub,
          ...
          <div style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:12, marginTop:20 }}>
            <div style={{ height:1, width:60, background:`linear-gradient(90deg,transparent,${tk.eyebrowLine})` }}/>
            <span style={{ color:tk.dot, fontSize:12,
              animation:"qaDotPulse 2.5s ease-in-out infinite", display:"inline-block" }}>⬡</span>
            <div style={{ height:1, width:60, background:`linear-gradient(90deg,${tk.eyebrowLine},transparent)` }}/>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ ...mono, fontSize:9, letterSpacing:".22em",
          ...
          <LangToggle lang={lang} setLang={handleLang} isDark={isDark}/>

          <p style={{ ...mono, fontSize:9, letterSpacing:".18em", margin:0,
