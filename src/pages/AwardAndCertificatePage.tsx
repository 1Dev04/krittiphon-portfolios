...
const certificates: Record<Tab, Cert[]> = {
  ...
  other: [
    ...
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285856/A1_vctren.png", title: "Generative AI และ ChatGPT ทำงานอย่างไร?",   desc: "Course instructors : อ. ดร.เอกพล ช่วงสุวนิช",  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285861/A2_g295om.png", title: "ChatGPT ช่วยทำวิจัยได้ไม่ต้องเหนื่อยแทบตาย (ในทุกขั้นตอน)", desc: " Course instructors : รศ. ดร.วิโรจน์ อรุณมานะกุล",  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285874/A3_tpd9xz.png", title: "แท็กติกการสอนในยุคคิดอะไรไม่ออกบอก ChatGPT",    desc: "Course instructors : ศ. ดร.จินตวีร์ คล้ายสังข์",  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285869/A4_jowrst.png", title: "ChatGPT กับเศรษฐกิจยุคใหม่เหนื่อยน้อยลง เเต่ได้ผลมากขึ้น",    desc: "Course instructors : ผศ. ดร.วรประภา นาควัชระ",  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285884/A5_xod5ou.png", title: "เขียนโค้ดคู่กับ AI เสร็จไว + ไม่ตกเทรนด์",    desc: "Course instructors : ผศ. ดร.ฑิตยา หวานวารี",  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285879/A6_nz3eur.png", title: "เย่! ไม่ต้องเรียน Python เเล้ว (หรือเปล่านะ) มี ChatGPT เเล้วนี่นา",    desc: `Course instructors : ผศ. ดร.สุกรี สินธุภิญโญ , รศ. ดร.วีระ เหมืองสิน , ผศ. ดร.นัทที นิภานันท์`,  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285895/A7_pm2kwu.png", title: "ChatGPT ถอยไปมาปล่อยพลัง AI ด้วย MICROSOFT x GPT4",    desc: "Course instructors : คุณโอม ศิวะดิตถ์",  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285890/A8_wznvwk.png", title: "การสอนในยุค AI จะเกิดอะไรขึ้น เมื่ออาจารย์ใช้ออกข้อสอบและเด็กใช้ทำข้อสอบ",    desc: "Course instructors : Dr.Virot 'TA' Chiraphadhanakul",  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285906/A9_h8kk67.png", title: "Visual Storytelling with Ai",    desc: `Course instructors : ตุลย์ เล็กอุทัย , อ.วรรษยุต คงจันทร์`,  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285911/A10_zua3sh.png", title: "ประเด็นจริยธรรมของ ChatGPT ที่ควรใส่ใจ",    desc: "Course instructors : รศ. ดร.ศิรประภา ชวะนะญาณ",  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285901/A11_khuqa4.png", title: "การเงินกับ AI สองเรื่องใกล้ตัวในชีวิตประจำวัน",    desc: "Course instructors : รศ. ดร.คณิสร์ แสงโชติ",  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285940/A12_awz3ri.png", title: "AI กับการตลาด 6.0: เปลี่ยนและปรับอะไรในสังคม",    desc: "Course instructors : ผศ. ดร.เอกก์ ภทรธนกุล",  tag: "AI",      color: "#818cf8" },
    { image: "https://res.cloudinary.com/dag73dhpl/image/upload/v1773285944/A13_e1ogec.png", title: "การปรับตัวใช้เครื่องมือ GenAI เพื่อผลลัพธ์ที่ดีกว่า",    desc: "Course instructors : ดร.อวิรุทธ์ ฉัตรมาลาทอง",  tag: "AI",      color: "#818cf8" },
  ],
};
